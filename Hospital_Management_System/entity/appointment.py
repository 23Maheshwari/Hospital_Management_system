class Appointment:
    ...
    def __str__(self):
        return f"Appointment [ID={self.__appointment_id}, PatientID={self.__patient_id}, DoctorID={self.__doctor_id}, Date={self.__appointment_date}, Description={self.__description}]"
